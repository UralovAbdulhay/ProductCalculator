...
public class Main extends Application {
    ...
    private static final String BAZA_COLCUL_DB = "baza/colcul.db";
    private static final String BUNDLE_BASE_NAME = "lan/tillar";
//    sample/Views/tillar_ru.properties
    ...
    private Connection connect() {
        ...
        try {
            conn = DriverManager.getConnection("jdbc:sqlite:" + BAZA_COLCUL_DB);
    ...
    public static void initResourceBundle() {
        bundle = ResourceBundle.getBundle(BUNDLE_BASE_NAME,
                LocaleConfig.getInstance().getLocale());
    }
    ...
    public void start(Stage primaryStage) {
        ...
        if (!(new StavkaConnections().isFullStavka())) {
            initStavka();
        }

        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Views/oyna.fxml"));
        initResourceBundle();
        ...
        Image icon = new Image("/Views/icon.png");
    ...
    private boolean createNewDatabase() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:sqlite:" + BAZA_COLCUL_DB)) {
            if (conn != null) {
