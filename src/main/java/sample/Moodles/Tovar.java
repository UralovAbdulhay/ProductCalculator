...
//    private int addCount = 1;
    ...
    public String getTovarTransportNarxiString() {
        return decimalFormat((double)(((int) (tovarTransportNarxi * 1000))/10))+ " %";
    }
    ...
    public String getTovarAksizString() {
        return decimalFormat((double)(((int) (tovarAksiz * 1000))/10))+ " %";
    }
    ...
    public String getTovarPoshlinaString() {
        return decimalFormat((double)(((int) (tovarPoshlina * 1000))/10))+ " %";
    }
