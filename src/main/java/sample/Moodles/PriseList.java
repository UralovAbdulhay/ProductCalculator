...
import sample.Classes.Connections.TovarConnections;
...
public class PriseList extends Tovar {
    ...
    public static void addPriseList(PriseList priseList) {
        new TovarConnections().insertToTovar(priseList);
        PriseList.reSetPriseList();
    }

    public static void addAllPriseLists(ObservableList<PriseList> priseLists) {
        priseLists.forEach(e -> new TovarConnections().insertToTovar(e));
        PriseList.reSetPriseList();
    }

    public static void reSetPriseList() {
        priseLists.clear();
        priseLists.addAll(new TovarConnections().getTovarFromSql());
        setTr();
    }

    public static void setPriseList(PriseList priseList) {
        new TovarConnections().updateTovar(priseList);
        PriseList.reSetPriseList();
    }
    ...
    public String getTovarDDPStr() {
        return decimalFormat(super.getTovarDDP());
    }
