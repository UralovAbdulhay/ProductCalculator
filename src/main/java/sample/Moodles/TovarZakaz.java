...
//        this.zakazCIPNarxiUSZ = (this.zakazCIPNarxiUSD * zakUsdUsz);                   // CIP Narxi UZS
    ...
    public String getZakazSummaExwStr() {
        return decimalFormat(zakazSummaExw);
    }
    ...
    public String getZakazTransSummStr() {
        return decimalFormat(zakazTransSumm);
    }
    ...
    public String getZakazTransLiSummaStr() {
        return decimalFormat(zakazTransLiSumma);
    }
    ...
    public String getZakazCIPNarxiUSDStr() {
        return decimalFormat(zakazCIPNarxiUSD);
    }
    ...
    public String getZakazCIPSummUSDStr() {
        return decimalFormat(zakazCIPSummUSD);
    }
    ...
    public double getZakazCIPNarxiUSZ() {
        return this.zakazCIPNarxiUSZ;
    }

    public String getZakazCIPNarxiUSZStr() {
        return decimalFormat(this.zakazCIPNarxiUSZ);
    }

    public double getZakazCIPSummUSZ() {
        return this.zakazCIPNarxiUSZ * this.zakazSoni;
    }

    public String getZakazCIPSummUSZStr() {
        return decimalFormat(this.zakazCIPNarxiUSZ * this.zakazSoni);
    }
    ...
    public String getZakazBojYiginiStr() {
        return decimalFormat(zakazBojYigini);
    }
    ...
    public String getZakazPoshlinaSummStr() {
        return decimalFormat(zakazPoshlinaSumm);
    }
    ...
    public String getZakazAksizSummStr() {
        return decimalFormat(zakazAksizSumm);
    }
    ...
    public String getZakazNDS1NarxiStr() {
        return decimalFormat(zakazNDS1Narxi);
    }
    ...
    public String getZakazKelishNarxiStr() {
        return decimalFormat(zakazKelishNarxi);
    }
    ...
    public String getZakazKelishSummStr() {
        return decimalFormat(zakazKelishSumm);
    }
    ...
    public String getZakazDDPnarxiStr() {
        return decimalFormat(zakazDDPnarxi);
    }
    ...
    public String getZakazDDPsummStr() {
        return decimalFormat(zakazDDPsumm);
    }
    ...
    public String getZakazNDS2liNarxiStr() {
        return decimalFormat(zakazNDS2liNarxi);
    }
    ...
    public String getZakazNDS2liSummStr() {
        return decimalFormat(zakazNDS2liSumm);
    }
    ...
    public String getTovarNarxiStr() {
        return decimalFormat(super.getTovarNarxi());
    }
    ...
    public String getTovarTransportNarxiStr() {
        return decimalFormat(super.getTovarTransportNarxi());
    }
    ...
    public String getStTransStr() {
        return decimalFormat(stavkalar.getStTrans());
    }
    ...
    public String getStCIPStr() {
        return decimalFormat(stavkalar.getStCIP());
    }
    ...
    public String getStUSD_USZStr() {
        return decimalFormat(stavkalar.getStUSD_USZ());
    }
    ...
    public String getStRUBStr_USZ() {
        return decimalFormat(stavkalar.getStUSD_RUB());
    }
    ...
    public String getStEUR_USZStr() {
        return decimalFormat(stavkalar.getStUSD_EUR());
    }
    ...
    public String getStBojxonaStr() {
        return decimalFormat(stavkalar.getStBojxona());
    }
    ...
    public String getStNDS1SStr() {
        return decimalFormat(stavkalar.getStNDS1S());
    }
    ...
    public double getStNDS1Bez() {
        return stavkalar.getStNDS1Bez();
    }

    public String getStNDS2Str() {
        return decimalFormat(stavkalar.getStNDS2());
    }
